        ...
        if (data.msg !== undefined) {
            ...
            try {
                ...
                if (data.part + 1 === data.total) {
                    ...
                    var innerHTML = ['<p><a href="', blobURL, '" class="btn btn-primary indigo darken-3" download="', escapeHtml(data.name), '">', i18n.download, '</a></p>'];
                    ...
                    if (data.type.match(/^image\//) !== null) {
                        ...
                        innerHTML.push('<p><a class="btn btn-primary indigo darken-3" id="showZipContent">', i18n.showZipContent, '</a></p>');
                    }
